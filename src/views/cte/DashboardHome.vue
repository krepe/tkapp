<template>
    <div id="home">
        ...
        <div class="lg:flex justify-between items-center mb-6">
            ...
            <button class="bg-purple hover:bg-purple-light focus:outline-none rounded-lg px-6 py-2 text-white font-semibold shadow duration-150">
                Emitir CT-e
            </button>
        </div>
                                ...
                                <tr class="border-b border-gray-200">
                                    <td class="px-6 py-4 whitespace-no-wrap">
                                        <div class="flex items-center">
                                            <div class="h-3 w-3 mr-2 rounded-full bg-green" />
                                            <div class="ml-4">
