<template>
    ...
    <div
        class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-25 border-r z-30 transition duration-500 ease-in-out"
        :class="sideBarOpen ? '' : 'hidden'"
        id="main-nav"
    >
        <RouterLink
            :to="{ name: 'Modules'}"
            class="w-full h-20 flex px-4 items-center mb-8"
        >
            <img
                :src="imgLogo"
                class="w-12 h-12"
        ...
        <div 
            class="mb-4 px-4 text-gray-800" 
            @click="toggleSidebar()"
        >
            <p class="pl-4 text-xs font-semibold mb-4">
                Principal
            </p>
            <RouterLink
            ...
            >
                ...
                <span class="text-gray-700">Emissão CT-e</span>
            </RouterLink>
            <RouterLink
                class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
                active-class="bg-gray-300"
